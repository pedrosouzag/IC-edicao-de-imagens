...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(64, 128, kernel_size=5) # 72 - 5 + 1 = 68 / 2 = 34 >> 128 matrizes 34 x 34
        ...
        self.fc1 = nn.Linear(128 * 34 * 34 , 256)
    ...
    def forward(self, x):
        ...
        # camada conv2: [32, 32, 148, 148] para [32, 64, 72, 72]
        x = F.max_pool2d(F.relu(self.conv2(x)), 2)

        # camada conv3 + dropout: [32, 64, 72, 72] para [32, 128, 34, 34]
        x = F.max_pool2d(F.relu(self.conv3(x)), 2)
        x = self.dropout(x)

        # flatten: [32, 128, 34, 34] para [32, 147968]
        x = x.view(-1, 128 * 34 * 34)

        # fc1: 128 * 34 * 34 para 256
        x = F.relu(self.fc1(x))
